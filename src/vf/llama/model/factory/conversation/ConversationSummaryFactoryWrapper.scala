...
/**
  * Common trait for classes that implement ConversationSummaryFactory by wrapping
  *  a ConversationSummaryFactory instance
  * @tparam A Type of constructed instances
  * @tparam Repr Implementing type of this factory
  * @author Mikko Hilpinen
  * @since 01.09.2024, v0.1
  */
trait ConversationSummaryFactoryWrapper[A <: ConversationSummaryFactory[A], +Repr] 
	extends ConversationSummaryFactory[Repr]
{
	// ABSTRACT	--------------------
