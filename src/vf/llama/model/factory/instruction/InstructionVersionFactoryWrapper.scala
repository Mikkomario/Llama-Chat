...
/**
  * Common trait for classes that implement InstructionVersionFactory by wrapping
  *  a InstructionVersionFactory instance
  * @tparam A Type of constructed instances
  * @tparam Repr Implementing type of this factory
  * @author Mikko Hilpinen
  * @since 01.09.2024, v0.1
  */
trait InstructionVersionFactoryWrapper[A <: InstructionVersionFactory[A], +Repr] 
	extends InstructionVersionFactory[Repr]
{
	// ABSTRACT	--------------------
