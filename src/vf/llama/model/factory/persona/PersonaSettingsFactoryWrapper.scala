...
/**
  * 
	Common trait for classes that implement PersonaSettingsFactory by wrapping a PersonaSettingsFactory instance
  * @tparam A Type of constructed instances
  * @tparam Repr Implementing type of this factory
  * @author Mikko Hilpinen
  * @since 01.09.2024, v0.1
  */
trait PersonaSettingsFactoryWrapper[A <: PersonaSettingsFactory[A], +Repr] 
	extends PersonaSettingsFactory[Repr]
{
	// ABSTRACT	--------------------
	...
	override def withLlmVariantId(llmVariantId: Int) = mapWrapped { _.withLlmVariantId(llmVariantId) }
