...
object StatementLinkDbProps
{
	...
	/**
	  ...
	  * @return A model which defines all statement link database properties
	  */
	def apply(table: Table, parentIdPropName: String = "parentId", 
		statementIdPropName: String = "statementId", 
		orderIndexPropName: String = "orderIndex"): StatementLinkDbProps = 
		_StatementLinkDbProps(table, parentIdPropName, statementIdPropName, orderIndexPropName)
	...
	/**
	  ...
	  * @param orderIndexPropName Name of the database property matching order index (default = "orderIndex")
	  */
	private case class _StatementLinkDbProps(table: Table, parentIdPropName: String = "parentId", 
		statementIdPropName: String = "statementId", orderIndexPropName: String = "orderIndex") 
		extends StatementLinkDbProps
	{
		// ATTRIBUTES	--------------------
...
/**
  * Common trait for classes which provide access to statement link database properties
  * @author Mikko Hilpinen
  * @since 01.09.2024, v0.1
  */
trait StatementLinkDbProps extends TextPlacementDbProps with HasIdProperty
{
	// ABSTRACT	--------------------
