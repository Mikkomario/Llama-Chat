...
/**
  * Common trait for classes that implement CustomMetaInfoFactory by wrapping a CustomMetaInfoFactory instance
  * @tparam A Type of constructed instances
  * @tparam Repr Implementing type of this factory
  * @author Mikko Hilpinen
  * @since 01.09.2024, v0.1
  */
trait CustomMetaInfoFactoryWrapper[A <: CustomMetaInfoFactory[A], +Repr] extends CustomMetaInfoFactory[Repr]
{
	// ABSTRACT	--------------------
	...
	override def withValue(value: String) = mapWrapped { _.withValue(value) }
