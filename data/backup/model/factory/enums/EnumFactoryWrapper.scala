...
/**
  * Common trait for classes that implement EnumFactory by wrapping a EnumFactory instance
  * @tparam A Type of constructed instances
  * @tparam Repr Implementing type of this factory
  * @author Mikko Hilpinen
  * @since 01.09.2024, v0.1
  */
trait EnumFactoryWrapper[A <: EnumFactory[A], +Repr] extends EnumFactory[Repr]
{
	// ABSTRACT	--------------------
